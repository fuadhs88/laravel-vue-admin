                ...
                <div class="form-group">
                  ...
                  <select class="form-control" v-model="form.category_id">
                    <option
                        ...
                        :value="id"
                        :selected="id === form.category_id">{{ category.name }}
                    </option>
                  </select>
...
export default {
  ...
  methods: {
    ...
    getResults(page = 1) {
      this.$Progress.start();
      axios.get('api/products?page=' + page).then(({data}) => (this.products = data.data));
    ...
    loadCategories() {
      axios.get("/api/categories/list").then(({data}) => (this.categories = data.data));
    },
    loadTags() {
